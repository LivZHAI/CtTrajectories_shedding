...
ggsave(fig_ct_fit_fulldata, file=paste0(savedir,"ct_fit_fulldata.pdf"), width=8, height=8)
ggsave(fig_ct_fit, file=paste0(savedir,"ct_fit.png"), width=8, height=8)
ggsave(fig_ct_fit_fulldata, file=paste0(savedir,"ct_fit_fulldata.png"), width=8, height=8)
